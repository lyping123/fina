...
<?php 
	...
	$qry_rcp = "SELECT * FROM f_cn WHERE cn_status = 'ACTIVE'".$s_name." AND receipt_type = '1' ORDER BY id DESC";
        ...
        <div class="row">
            ...
            <table id="mytable" class="table table-bordred table-striped" style="width:100%">
                ...
                <?php while($row_rcp = mysqli_fetch_array($result_rcp)){
						$rd_qry = "SELECT cn_desc,cn_amount FROM f_cn_detail WHERE cn_id = '".$row_rcp['id']."'";
                	...
                	<tr>
                        ...
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu dropdown-menu-right">
                            <li><a href="f_cn_print.php?&id=<?=$row_rcp['id']?>" target="_blank"><i class="icon-print"></i> Print <!-- (Synergy Central Academy) --></a></li>
