...
<form class="form-horizontal" method="post" action="f_student_receipt.php" enctype="multipart/form-data"> 
		<div class="row">
            <div class="col-lg-12">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class="form-control" name="name" id="name" type="text" value="<?=$_SESSION["name"]?>" readonly>
                                <input type='hidden' class="form-control" name="sid" id="sid" value="<?=$_SESSION["id"]?>" readonly>
							</div>

							<div class="form-group">
								<label>Student IC</label>
								<input class="form-control" name="ic" id="ic" type="text" value="<?=$_SESSION["ic"]?>" readonly>
							</div>
...
<script>
	...
	$('#c_type').on('change', function(){
		...
		if(selected == '1'){
            ...
            $('#bill_type')
                .empty()
                .append('<option value="">Choose</option><option value="Internal Exam Fee">Internal Exam Fee</option><option value="Hostel Fee">Hostel Fee</option><option value="Hostel Deposit">Hostel Deposit</option><option value="Tuition Fee">Tuition Fee</option>');
        }
	});
