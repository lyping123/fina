    ...
    <div class="panel-body">
        ...
        <div class="col-md-5">
            ...
            <select name="syllabus" class="form-control" required>
                ...
                <option value="BAHASA TAMIL" <?php if($row['syllabus'] == 'BAHASA CINA/CHINESE'){echo "selected=\"selected\"";}?>>BAHASA TAMIL</option>
                <option value="PENDIDIKAN ISLAM/ISLAMIC STUDIES" <?php if($row['syllabus'] == 'PENDIDIKAN ISLAM/ISLAMIC STUDIES'){echo "selected=\"selected\"";}?>>PENDIDIKAN ISLAM/ISLAMIC STUDIES</option>
                ...
                <option value="SAINS/SCIENCE" <?php if($row['syllabus'] == 'SAINS/SCIENCE'){echo "selected=\"selected\"";}?>>SAINS/SCIENCE</option>
                <option value="SAINS PERTANIAN" <?php if($row['syllabus'] == 'SAINS PERTANIAN'){echo "selected=\"selected\"";}?>>SAINS/SCIENCE</option>
                <option value="SEJARAH/HISTORY" <?php if($row['syllabus'] == 'SEJARAH/HISTORY'){echo "selected=\"selected\"";}?>>SEJARAH/HISTORY</option>
                ...
                <option value="GEOGRAFI" <?php if($row['syllabus'] == 'GEOGRAFI'){echo "selected=\"selected\"";}?>>BIOLOGY</option>
                ...
                <option value="KESUSASTERAAN CINA/CHINESE LITERATURE" <?php if($row['syllabus'] == 'KESUSASTERAAN CINA/CHINESE LITERATURE'){echo "selected=\"selected\"";}?>>KESUSASTERAAN CINA/CHINESE LITERATURE</option>
                <option value="KESUSASTERAAN MELAYU/MALAY LITERATURE" <?php if($row['syllabus'] == 'KESUSASTERAAN MELAYU/MALAY LITERATURE'){echo "selected=\"selected\"";}?>>KESUSASTERAAN MELAYU/MALAY LITERATURE</option>
                ...
                <option value="ENGLISH FOR SCIENCE & TECHNOLOGY"<?php if($row['syllabus'] == 'ENGLISH FOR SCIENCE & TECHNOLOGY'){echo "selected=\"selected\"";}?>>ENGLISH FOR SCIENCE & TECHNOLOGY</option>
                <option value="REKA CIPTA"<?php if($row['syllabus'] == 'ENGLISH FOR SCIENCE & TECHNOLOGY'){echo "selected=\"selected\"";}?>>REKA CIPTA</option>
                <option value="PENGETAHUAN SAINS SUKAN"<?php if($row['syllabus'] == 'ENGLISH FOR SCIENCE & TECHNOLOGY'){echo "selected=\"selected\"";}?>>PENGETAHUAN SAINS SUKAN</option>
                <option value="KHB-PERDAGANGAN DAN KEUSAHAWANAN"<?php if($row['syllabus'] == 'ENGLISH FOR SCIENCE & TECHNOLOGY'){echo "selected=\"selected\"";}?>>KHB-PERDAGANGAN DAN KEUSAHAWANAN</option>
            </select>
            </div>
            <div class="form-group">
            <label>result</label>
