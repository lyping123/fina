...
<body>
    <div class="container">
        <center>
            <h1>Outstanding Panel</h1>
            <hr>
            <div class="row">
                <div class="col-md-12">
                    <a href="check_outstanding1.php" class="btn btn-primary">Tuition fee</a>
                    <br>
                    <br>
                    <a href="check_outstandinghostel.php" class="btn btn-danger">Hostel fee </a>
                </div>
            </div>
            <hr>
        </center>
