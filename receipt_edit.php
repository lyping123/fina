...
$qry = "SELECT * FROM receipt WHERE r_status = 'ACTIVE' AND id = '".$_GET['id']."'";
...
$new_no = $no + $c_row;
?>
<form class="form-horizontal" method="post" action="rp_detail.php?id=<?=$row['id']?>" enctype="multipart/form-data"> 
		<div class="row">
            <div class="col-lg-12">
...
  </tr>
<?php
$qry_cart = "SELECT * FROM receipt_detail WHERE r_id = '".$_GET['id']."'";
...
?>
  <tr>
    ...
    <td><a class="btn btn-danger" href="rp_detail.php?action=delete&id=<?=$row_cart['id']?>&r_id=<?=$row_cart['r_id']?>" onclick="return confirm('Confirm to Delete this Record?')"> Delete </a></td>
  </tr>
<?php }?>
</table>
</div>
...
<!--<div class="panel panel-info">
    ...
    <div class="panel-body">  
            ...
            <div class="col-lg-6">
<?php
	$bc_qry = "SELECT * FROM b_c WHERE r_id = '".$_GET['id']."'";
