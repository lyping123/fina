                ...
                <div class="row">
                    <div class="col-lg-3">
                        ...
                        <div id="basic-example">
                            <input id="my-input1" class="form-control typeahead" name="name" type="text" value="<?=$get_name?>" style="width:262.5px;" onfocusout="showHint(this.value);">
                        </div>
                    </div>
