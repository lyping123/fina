...
<script>
	...
	$('#c_type').on('change', function(){
		...
		if(selected == '1'){
            ...
            $('#bill_type')
                .empty()
                .append('<option value="">Choose</option><option value="Debtor PTPK">Debtor PTPK</option><option value="Debtor">Debtor</option><option value="Internal Exam Fee">Internal Exam Fee</option><option value="Hostel Fee">Hostel Fee</option><option value="Hostel Deposit">Hostel Deposit</option><option value="Tuition Fee">Tuition Fee</option><option value="Tuition PTPK">Tuition PTPK</option><option value="Personal Bond">Personal Bond</option>');
        }
	});
