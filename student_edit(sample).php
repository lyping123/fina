...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <div class="col-md-5">
            ...
            <input type="text" class="form-control" name="outstanding" value="<?=$row['outstanding']?>" >
            </div>
            <div class="form-group">
                <div class="col-md-4">
                ...
                <div style="display:none;" id="smr" class="col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group date form_month" data-date="mm-yyyy" data-date-format="mm-yyyy" data-link-field="dtp_input3" id="semester_month" data-link-format="mm-yyyy">
<input class="form-control" size="16" type="text" value="" >
<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
</div>
<input type="hidden" name="semester_month" id="dtp_input3" value="" />
...
<script>
    ...
    var a=$("#dtp_input3").val();
    var from = a.split("-")
    
    var milliseconds  = Date.parse(from[1] - 1, from[0]);
    alert(milliseconds);
    var b=new Date();
    var c=b.getMonth();
    var month=c+1;
    var month_left=a-month;
    if(month_left>0){
