...
echo $qry = "SELECT * FROM school WHERE id = '".$_GET['id']."'";
...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <form class="form-horizontal" method="post" action="add_qualification.php?action=edit_school&id=<?=$row['id']?>" enctype="multipart/form-data">    
        <div class="col-md-5">
            ...
            <input type="text" class="form-control" name="name" value="<?=$row['name_school']?>" required>
            </div>
            <div class="form-group">
