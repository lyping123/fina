...
$qry="SELECT *, stu.course as new_course FROM student AS stu
	  LEFT JOIN school AS sch ON stu.id = sch.s_id
	  LEFT JOIN course AS c ON c.course = stu.course
      LEFT JOIN (SELECT sg1.g_level, tt.s_id, sg1.g_name
                          ...
                          <style>
                            ...
                            <tr <?php if($row['s_status'] == 'GRADUATE'){ echo 'style="background-color:  #dff0d8;"';}elseif($row['s_status'] == 'QUIT'){ echo 'style="background-color:  #dc3545;"';}else{ } ?>>
                              ...
                              <td><div class="dropdown">
                                  ...
                                  <?php }?>
                                    <li class="divider"></li>
                                    <?php if($row['s_status']=="ACTIVE"){ ?><li> <a href="add_student_job.php?action=graduatejob&id=<?=$row[0]?>" onclick="return confirm('Are you sure set thie student status as graduate?')">Graduate</a></li><?php } ?>
                                  </ul>
                                </div></td>  
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
  ...
  <div class="row">
        <div class="col-md-12">
                <div class="form-group">
                    <label>Reason</label>
                    <input class="form-control" name="reason" type="text" value="" placeholder="" required>
                </div>
                <div class="form-group">
