...
echo $qry = "SELECT * FROM result WHERE id = '".$_GET['id']."'";
...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <form class="form-horizontal" method="post" action="add_qualification.php?action=edit_result&id=<?=$row['id']?>" enctype="multipart/form-data">    
        <div class="col-md-5">
