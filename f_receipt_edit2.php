...
<form class="form-horizontal" method="post" action="f_receipt2.php?action=edit&id=<?=$_GET['id']?>" enctype="multipart/form-data"> 
        <div class="row">
            <div class="col-lg-6">
<div class="panel panel-info">
    <header class="panel-heading">
           ...
           <div class="col-md-12">
            <div class="form-group">
                ...
                <div id="basic-example">
                    <input class="form-control" name="name" type="text" value="<?=$row['s_name']?>" style="width:523px;">
                ...
                <div class="form-group">
                    <label>NRIC</label>
                    <input type="text" class="form-control" name="ic" value="<?=$row['s_ic']?>">
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input class="form-control" size="16" type="text" value="<?=$row['r_date']?>">
...
<div class="panel panel-info">
    <header class="panel-heading">
    <h3 class="panel-title">Debtor PTPK</h3>
    </header>
    <div class="panel-body">  
            <div class="col-md-12">
                <div class="form-group">
					<input type="checkbox" id="debtor_ptpk" name="debtor_ptpk" value="debtor_ptpk" onclick="validate6()" <?php if($row['debtor_ptpk'] == 'YES'){ echo 'checked'; }?>> Debtor PTPK
                </div>
            </div>
    </div>  
</div>
<div class="panel panel-info">
    ...
    <div class="panel-body">  
            <div class="col-md-12">
                <div class="form-group">
					<input type="checkbox" id="debtor" name="debtor" value="debtor" onclick="validate5()" <?php if($row['debtor'] == 'YES'){ echo 'checked'; }?>> Debtor
                </div>
            </div>
    </div>  
</div>
<div class="panel panel-info">
    ...
    <div class="panel-body">  
            <div class="col-md-12">
                <div class="form-group">
					<input type="checkbox" id="internal" name="internal" value="internal" onclick="validate4()"  <?php if($row['internal_exam_fee'] == 'YES'){ echo 'checked'; }?>> Deduct From Internal Exam Fee
                </div>
            </div>
    </div>  
</div>
<div class="panel panel-info">
    ...
    <div class="panel-body">  
            <div class="col-md-12">
                <div class="form-group">
					<input type="checkbox" id="hostel" name="hostel" value="hostel" onclick="validate3()"  <?php if($row['hostel_fee'] == 'YES'){ echo 'checked'; }?>> Deduct From Hostel Fee
                </div>
            </div>
    </div>  
</div>
<div class="panel panel-info">
    ...
    <div class="panel-body">  
            <div class="col-md-12">
                <div class="form-group">
					<input type="checkbox" id="tuition" name="tuition" value="tuition" onclick="validate2()"  <?php if($row['tuition_fee'] == 'YES'){ echo 'checked'; }?>> Deduct From Tuition Fee
                </div>
            </div>
    </div>  
</div>
<div class="panel panel-info">
    <header class="panel-heading">
    <h3 class="panel-title">Tuition PTPK</h3>
    </header>
    <div class="panel-body">  
            <div class="col-md-12">
                <div class="form-group">
					<input type="checkbox" id="t_ptpk" name="t_ptpk" value="t_ptpk" onclick="validate7()" <?php if($row['tuition_ptpk'] == 'YES'){ echo 'checked'; }?>> Deduct From Tuition PTPK
                </div>
            </div>
    </div>  
</div>
...
<div class="panel panel-info">
    <header class="panel-heading">
    <h3 class="panel-title"><input type="checkbox" id="bankin" name="bankin" value="bankin" onclick="validate1()" <?php if($row['pay_mtd'] == 'bankin'){ echo 'checked'; }?>> Bank In</h3>
    </header>
    <div class="panel-body"> 
            <div class="col-md-12">
                <div class="form-group">
                <label>Banker</label>
                <select name="bankin_banker" class="form-control" id="bankin_banker" <?php if($row['pay_mtd'] == 'bankin'){ echo 'checked'; }else{ echo 'disabled';}?>>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" size="16" type="text" id="bank_in_date" <?php if($row['pay_mtd'] == 'bankin'){ echo "value='$bc_row[in_date]'"; }else{ echo 'disabled';}?>>
...
<div class="panel panel-info">
    <header class="panel-heading">
    <h3 class="panel-title"><input type="checkbox" id="cheque" name="cheque" value="cheque" onclick="validate()" <?php if($row['pay_mtd'] == 'cheque'){ echo 'checked'; }?>> Cheque</h3>
    </header>
    <div class="panel-body">   
            <div class="col-md-12">
                <div class="form-group">
                <label>Cheque No</label>
                <input type="text" class="form-control" name="c_no" id="c_no"  <?php if($row['pay_mtd'] == 'cheque'){ echo "value='$bc_row[cheque_no]'"; }else{ echo 'disabled';}?>>
                </div>
                <div class="form-group">
                <label>Banker</label>
                <select name="banker" class="form-control" id="banker" <?php if($row['pay_mtd'] == 'cheque'){ echo 'checked'; }else{ echo 'disabled';}?>>
                    <option value="">Select The Bank</option>
                    <option value="Affin Bank Berhad" <?php if($bc_row['cheque_no'] != 'BANKIN' && $bc_row['banker'] == 'Affin Bank Berhad'){ echo "selected"; }?>>Affin Bank Berhad</option>
                    <option value="Alliance Bank" <?php if($bc_row['cheque_no'] != 'BANKIN' && $bc_row['banker'] == 'Alliance Bank'){ echo "selected"; }?>>Alliance Bank</option>
                    <option value="AmBank Berhad" <?php if($bc_row['cheque_no'] != 'BANKIN' && $bc_row['banker'] == 'AmBank Berhad'){ echo "selected"; }?>>AmBank Berhad</option>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" size="16" type="text" id="b_date" <?php if($row['pay_mtd'] == 'cheque'){ echo "value='$bc_row[in_date]'"; }else{ echo 'disabled';}?>>
...
function validate2(){
	if(document.getElementById('tuition').checked) {
		...
		document.getElementById('debtor_ptpk').disabled = true;
		document.getElementById('t_ptpk').disabled = true;
	} else {
		...
		document.getElementById('debtor_ptpk').disabled = false;
		document.getElementById('t_ptpk').disabled = false;
	}
}
...
function validate6(){
	if(document.getElementById('debtor_ptpk').checked) {
		document.getElementById('hostel').disabled = true;
		document.getElementById('tuition').disabled = true;
		document.getElementById('internal').disabled = true;
		document.getElementById('debtor').disabled = true;
...
function validate7(){
	if(document.getElementById('t_ptpk').checked) {
		document.getElementById('hostel').disabled = true;
		document.getElementById('tuition').disabled = true;
		document.getElementById('internal').disabled = true;
		document.getElementById('debtor').disabled = true;
