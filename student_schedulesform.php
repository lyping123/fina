    ...
    if (file_exists($target_file)) {
      ...
      // if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
          ...
          $qry="INSERT INTO `student_class`(`s_id`, `img`) VALUES".$new_sql;
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3>Add class schedules form</h3>
                </div>
                <div class="panel-body" >
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>Student class schedules</label>
...
<?php 
$qry="SELECT s.s_name,sc.img,course FROM student s INNER JOIN student_class sc ON s.id=sc.s_id
    ...
    <div class="col-md-12">
      <div  class="table-responsive">
            <table id="example1" class="table table-bordered">
                  <thead>
                      <th>Student Name</th>
                      <th>Class schedules document</th>
                      <th>Course</th>
