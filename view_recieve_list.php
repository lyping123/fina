...
$qry="select cr.*,s.s_name, s.course  from certificate_receive  as cr 
...
<body>
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Certificate receive list
            ...
            <div class="col-md-12">
                <table id="example1" class="table table-bordred table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        $select="select * from certificate_receive where s_id='$result[s_id]'";
                        ...
                        <tr>
                            ...
                            <td><?=$date?></td>
                            <td><?=$lvl?></td>
                            <td><a class="btn btn-primary" href="edit_cer.php?id=<?=$result["s_id"]?>">Edit</a></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
