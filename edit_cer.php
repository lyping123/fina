...
$qry="select * from certificate_receive as cr inner join student as s on s.id=cr.s_id where cr.s_id='".$_GET["id"]."'";
    ...
    $name=$result["s_name"];
        $div.="
                                <div class='col-md-4'>
                                    ...
                                    <input type='date' name='c_date[]'  class='form-control' placeholder='' value='$result[receive_date]'  />
                                    </div>
                                </div>";
}
...
if(isset($_POST["submit"])){
    ...
    if($_POST["name"]!==""){
        ...
        if($update){
            echo "<script>
                alert('edit success');
                window.location.href='view_recieve_list.php';
            </script>";
        }else{
            echo "<script>
            alert('edit fail');
        ...
        $delete=mysqli_query($conn,"delete from certificate_receive where s_id='$_GET[id]'");
        $insert="insert into certificate_receive(cel_no,receive_date,level,s_id) values".$newsql;
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3>certificate receive form</h3>
                    </div>
