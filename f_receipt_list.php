...
<?php 
	...
	$qry_rcp = "SELECT * FROM f_receipt WHERE r_status = 'ACTIVE'".$s_name." ORDER BY id DESC";
        ...
        <div class="row">
            ...
            <table id="mytable" class="table table-bordred table-striped" style="width:100%">
				...
				?>
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li><a href="f_receipt_edit.php?&id=<?=$row_rcp['id']?>">Edit</a></li>
                    <li><a href="f_receipt.php?action=delete_receipt&id=<?=$row_rcp['id']?>">Delete</a></li>
                  </ul>
                </div></td>
                    </tr>
                <? }?>
