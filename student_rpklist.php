...
$qry="SELECT * FROM student_rpk where s_id='$_SESSION[id]'";
...
<div class="container">
    <div class="col-md-12">
        ...
        <div class="switch-panel__tabs">
            ...
            ?>
            <button class="switch-panel__tab <?=$active?>" onclick="switchContent(<?=$i?>)">level <?=$ii?></button>
            <?php $ii++;} ?>
        ...
        <?php 
            $i=1;
            if($num==0){
              echo "<h2>RPK rsult not release yet</h2>";
            }else{
