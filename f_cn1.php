...
if(isset($_POST['submit']) && $_POST['submit'] == 'save'){
	...
	if($c_rows > 0){
		...
		$qry_save = "INSERT INTO f_cn(debtor,internal_exam_fee, cn_date, s_id, pay_mtd, tuition_fee, ptpk, cn_status, 
									  createdate, createby, hostel_fee, receipt_type , org_bill_no)
							   VALUES('YES', 'NO','".$_POST['date']."', '".mysqli_real_escape_string($conn,$_POST['name'])."', 'cash', 'NO','NO', 'ACTIVE', 
							   		  '".DATE_TODAY."', '".$_SESSION['id']."', 'NO', '".$_POST['c_type']."', '".$_POST['org_bill_no']."')";
