...
echo $qry = "SELECT * FROM school WHERE s_id='". $_GET['id'] ."' AND status='ACTIVE'";
$result = mysqli_query($conn, $qry);
  
mysqli_set_charset($conn, 'utf8');	
echo $qry_r = "SELECT * FROM result WHERE s_id='". $_GET['id'] ."' ";
                ...
                <table id="mytable" class="table table-bordred table-striped" style="width:100%">
                  ...
                  <button class="btn btn-primary dropdown-toggle " type="button" data-toggle="dropdown">Action<span class="caret"></span></button>
                      <ul class="dropdown-menu dropdown-menu-right">
                        <li><a href="school_edit.php?action=edit_school&id=<?=$row['id']?>">Edit</a></li>
                        <li><a href="add_qualification.php?action=delete_school&id=<?=$row['id']?>">Delete</a></li>
                      </ul>
                    </div></td>
                        </tr>
                    <?php }?>
        ...
        <div class="col-md-12">
            ...
            <div class="col-lg-12">
                ...
                <table id="mytable" class="table table-bordred table-striped" style="width:100%">
                  ...
                  <button class="btn btn-primary dropdown-toggle " type="button" data-toggle="dropdown">Action<span class="caret"></span></button>
                      <ul class="dropdown-menu dropdown-menu-right">
                        <li><a href="result_edit.php?action=result_edit&id=<?=$row['id']?>">Edit</a></li>
                        <li><a href="add_qualification.php?action=delete_result&id=<?=$row['id']?>">Delete</a></li>
                      </ul>
                    </div></td>
                        </tr>
                    <?php }?>
