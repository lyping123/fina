...
if(isset($_POST['submit']) && $_POST['submit'] == 'save'){
	...
	$qry = "INSERT INTO login(l_username,l_password,level,l_name,c_id,dp,l_status,teach_lv)VALUES('".mysqli_real_escape_string($conn,$_POST['username'])."','".mysqli_real_escape_string($conn,$_POST['password'])."','pp','".mysqli_real_escape_string($conn,$_POST['name'])."','".$_POST['course']."','".$_POST['dp']."','ACTIVE','".$_POST['level']."')";
