...
if(isset($_POST['submit']) && $_POST['submit'] == 'edit_school'){
			...
			mysqli_set_charset($conn, 'utf8');
		    $qry = "UPDATE school SET name_school='".$_POST['name']."',location='".$_POST['location']."',qualification='".$_POST['qualification']."',year='".$_POST['year']."',former='".$_POST['former']."' WHERE id = '".$_GET['sid']."'";
