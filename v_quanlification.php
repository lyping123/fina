...
$qry="select * from verification where id='$_GET[id]'";
$sttr=mysqli_query($conn,$qry);
$row=mysqli_fetch_array($sttr);
    
mysqli_set_charset($conn, 'utf8');	
$qry = "SELECT * FROM school WHERE s_ic='".$row["s_ic"]."' AND status='ACTIVE'";
$result = mysqli_query($conn, $qry);
  
mysqli_set_charset($conn, 'utf8');	
$qry_r = "SELECT * FROM result WHERE s_ic='".$row['s_ic']."' ";
...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <form class="form-horizontal" method="POST" action="add_vqualification.php?type=visitor&&s_ic=<?=$row["s_ic"]?>" enctype="multipart/form-data">    
        <div class="col-md-12 ">
...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <form class="form-horizontal" method="post" action="add_vqualification.php?s_ic=<?=$row["s_ic"]?>" enctype="multipart/form-data">    
        <div class="col-md-12 ">               	
            <div class="form-group">
