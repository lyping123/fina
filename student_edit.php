...
?>
        <!-- Page Header -->
        <a class="btn btn-warning" href="student_list.php">Back</a>
        <div class="row">
            <div class="col-md-12">
                <?php 
...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <div class="col-md-5">
            ...
            <input type="text" class="form-control" name="b_sen" value="<?=$row['birth_sen']?>" >
            </div>
            <div class="form-group">
            ...
            <input type="text" class="form-control" name="i_fee" value="<?=$row['int_outstanding']?>" >
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
            <label>Tuition Fee Balance left</label>
            <input type="text" class="form-control" name="l_fee" value="<?php $total_left=$row['tuition_fee_left']-$row3['amo'];if($total_left<=0){echo 0;}else{echo $total_left;}?>" >
            </div>
            <div class="form-group">
            <label>Outstanding left</label>
            <!-- <?php $total=$row['outstanding']-$row2['amo'];if($total<=0){echo 0;}else{echo $total;}?> -->
            <input type="text" class="form-control" name="outstanding" value="<?=$outstadind?>" >
            </div>
            <!--<div class="form-group">
            <label>Outstanding Left</label>
            ...
            <div class="form-group">
            <label>Month of tuition fee</label>
            <input type="text" class="form-control" name="t_in" value="<?=$row['month']?>" >
            </div>
            <div class="form-group">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1" data-link-format="yyyy-mm-dd">
                                <input class="form-control" size="16" type="text" name="t_start" value="<?=$row["t_start"]?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group date form_date" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1" data-link-format="yyyy-mm-dd">
                                <input class="form-control" size="16" type="text" name="t_end" value="<?=$row["t_end"]?>">
                                <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                            </div>
                        </div>
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="m_l" value="<?=$row['month_pay']?>" >
                        </div>
                    </div>
                </div>
...
<input type="hidden" name="check_in" id="dtp_input4" value="" />
        ...
        <div class="col-md-5">
            ...
            <img src="http://registration.synergy-college.org/img/<?=$row['photo']?>" style="height: 200px;">
            <input type="file" class="form-control" name="photo" value="">
            </div>
            <div class="form-group">
            ...
            <input class="form-control" size="16" name="birthday" type="text" value="<?=$row['birthday']?>" >
            <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
            <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
            </div>
            <input type="hidden" id="dtp_input2" value="<?=$row['birthday']?>" /> -->
...
<input type="hidden" name="join_date" id="dtp_input3" value="<?=$row['date_join']?>" />
            ...
            <div class="form-group">
                <label>PTPK No File</label>
                <input type="text" name="file_no" class="form-control" placeholder="file NO" value="<?php echo $row["file_num"] ?>" />
            </div>
            <div class="col-md-6">
            <div class="form-group">
                <fieldset>
            ...
            <input type="hidden" name="birthday" id="dtp_input3" value="" />
                    ...
                    <br>
                    <button type="button" class="btn btn-primary" id="create" name="create">Submit</button>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <table class="table table-bordred table-striped" id="tbl">
                        <thead>
                            <th>Cel no</th>
                            <th>Exam date</th>
                            <th>Certificate receive date</th>
                            <th>Level</th>
                            <th>delete</th>
                        </thead>
                        <tbody>
                            <?php 
                                $qry="select * from certificate where s_id='".$_GET["id"]."'";
                                $sql=mysqli_query($conn,$qry);
                                while($row=mysqli_fetch_array($sql)){
                                    echo "<tr>";
                                    echo "<td>".$row["cel_no"]."</td>";
                                    echo "<td>".$row["exam_date"]."</td>";
                                    echo "<td>".$row["certificate_date"]."</td>";
                                    echo "<td>".$row["level"]."</td>";
                                    echo "<td><button type='button' class='btn btn-danger delete' value='$row[id]'>Delete</button></td>";
                                    echo "<tr>";
                                }
                            ?>                   
                        </tbody>
