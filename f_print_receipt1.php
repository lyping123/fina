...
$qry = "SELECT *,r.s_name AS old_name,r.r_date as receipt_date FROM f_receipt AS r
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="4">
    ...
    <br />
        ...
        <td colspan="1" valign="bottom" width="10%" align="right">
            <div style="<!--direction:rtl-->;text-align: left;margin-left: 70px;">
                <strong>Official Receipt </strong><br />
                <strong>No </strong>: <?=$r_no?><br />
                <strong>Date </strong>: <?=date_format(new DateTime($row['receipt_date']),'d-m-Y')?>
            </div>
        </td>
    </tr>
  </table>
        ...
        <div class="bottomleft">
            ...
            <tr >
                ...
                ?>
                    ...
                    <i style="text-decoration: underline;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<?=$sig?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</i>               
                    </td>
                    <td colspan="2"></td>
                    <td colspan="2"></td>
                    <td colspan="2" align="center" valign="bottom">
