...
if(isset($_POST['submit']) && $_POST['submit'] == 'save'){
	...
	if($c_rows > 0){
		...
		if($result_save = mysqli_query($conn, $qry_save)){
			...
			$sttr_sum=mysqli_query($conn,$sum_query);
			$result_add=mysqli_fetch_array($sttr_sum);
			 $up="update student set p_month=p_month-".$_POST['stage'].",tuition_fee=tuition_fee-".$result_add['amount'].",rep_date ='".$_POST['date']."' where id='".$_POST['name']."'";
			$sttr_up=mysqli_query($conn,$up);
			 $query_tui="insert into tuitionfee_detail(s_id,r_id,rep_date)values('".$_POST['name']."','".$r_id."','".$_POST['date']."')";
