...
<form class="form-horizontal" method="post" action="f_receipt1testingmode.php" enctype="multipart/form-data"> 
		<div class="row">
            <div class="col-lg-12">
...
<hr />
		...
		<option value="Tuition PTPK">Tuition PTPK</option>
								...
								<div id="step3"></div>
								<div class="form-group">
                            	<button type="button" disabled='disabled' class="btn btn-danger" id="add_payment"><span></span>Add payment</button>
                                <div class="form-group" style="margin-top:10px;">
	

<div class="col-md-4">
	<select name="desc[]" id="dcc" class="form-control">
        
    </select>
</div>
<div id="cour" class="col-md-3">
    <select id="c_id" name="course[]" class="form-control">
        <option value="">Choose</option>
        <option class="pro" value="Programming">Programming</option>
        <option class="net" value="Networking">Networking</option>
        <option class="mul" value="Multimedia">Multimedia</option>
        <option class="ele" value="Electronic">Electronic</option>
        <option class="acc" value="Acounting">Acounting</option>
    </select>
</div>
<div id="lvl" class="col-md-2">
...
<script>
	...
	$('#bill_type').on('change',function(){
        ...
        if(name=="Tuition Fee"){
            variable+="<option value='TUITION FEE'>Tuition Fee</option>";
            variable+="<option value='TUITION FEE'>Tuition Fee-1st payment</option>";
            variable+="<option value='TUITION FEE'>Enrollment Fee</option>";
            
            $("#cour").attr("style","display:block");
            $("#lvl").attr("style","display:block");
        }
        else if(name=="Hostel Fee"){
            variable+="<option value='HOSTEL FEE'>Hostel Fee</option>";
            
            $("#cour").attr("style","display:none");
            $("#lvl").attr("style","display:none");
           
        }
        else if(name=="Debtor PTPK"){
            variable+="<option value='DEBTOR PTPK'>debtor PTPK</option>";
            
            $("#cour").attr("style","display:block");
            $("#lvl").attr("style","display:block");
        }
        else if(name=="Internal Exam Fee"){
            variable+="<option value='INTERNAL EXAMINATION FEE'>Internal Exam Fee</option>";
            
            $("#cour").attr("style","display:block");
            $("#lvl").attr("style","display:block");
        }
        else if(name=="Tuition PTPK"){
            variable+="<option value='TUITION PTPK'>Tuition PTPK</option>";
            ...
            variable+="<option value='DEBTOR'>Debtor</option>";
