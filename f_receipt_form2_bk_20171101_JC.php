...
$new_no = $no + $c_row;
?>
<form class="form-horizontal" method="post" action="f_receipt2.php" enctype="multipart/form-data"> 
		<div class="row">
            <div class="col-lg-12">
...
  </tr>
<?php
$qry_cart = "SELECT * FROM f_cart2 WHERE u_id = '".$_SESSION['id']."'";
...
?>
  <tr>
    ...
    <td><a class="btn btn-danger" href="f_receipt2.php?action=delete&id=<?=$row_cart['id']?>" onclick="return confirm('Confirm to Delete this Record?')"> Delete </a></td>
  </tr>
<?php }?>
</table>
</div>
...
<div class="panel panel-info">
    ...
    <div class="panel-body">  
            <div class="col-md-12">
                <div class="form-group">
					<input type="checkbox" id="debtor_ptpk" name="debtor_ptpk" value="debtor_ptpk" onclick="validate6()" required> Debtor PTPK
                </div>
            </div>
    </div>  
</div>
<div class="panel panel-info">
    ...
    <div class="panel-body">  
            <div class="col-md-12">
                <div class="form-group">
					<input type="checkbox" id="debtor" name="debtor" value="debtor" onclick="validate5()" required> Debtor
                </div>
            </div>
    </div>  
</div>
<div class="panel panel-info">
    ...
    <div class="panel-body">  
            <div class="col-md-12">
                <div class="form-group">
					<input type="checkbox" id="internal" name="internal" value="internal" onclick="validate4()" required> Deduct From Internal Exam Fee
                </div>
            </div>
    </div>  
</div>
<div class="panel panel-info">
    ...
    <div class="panel-body">  
            <div class="col-md-12">
                <div class="form-group">
					<input type="checkbox" id="hostel" name="hostel" value="hostel" onclick="validate3()" required> Deduct From Hostel Fee
                </div>
            </div>
    </div>  
</div>
<div class="panel panel-info">
    ...
    <div class="panel-body">  
            <div class="col-md-12">
                <div class="form-group">
					<input type="checkbox" id="tuition" name="tuition" value="tuition" onclick="validate2()" required> Deduct From Tuition Fee
                </div>
            </div>
    </div>  
</div>
<div class="panel panel-info">
    ...
    <div class="panel-body">  
            <div class="col-md-12">
                <div class="form-group">
					<input type="checkbox" id="t_ptpk" name="t_ptpk" value="t_ptpk" onclick="validate7()" required> Deduct From Tuition PTPK
                </div>
            </div>
    </div>  
</div>
