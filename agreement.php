                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label>I confirm that I have read the contents of this handbook and acknowledge that I agree to abide with the Hostel Rules and Regulations. I fully understand and agree that disciplinary action can be taken against me if I fail to observe the rules and regulations both expressed and implied. </label>
                                        </div>
                                        <div class="form-group">
