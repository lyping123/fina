...
if(isset($_POST['submit']) && $_POST['submit'] == 'save'){
	...
	if($c_rows > 0){
		...
		$qry_save = "INSERT INTO f_receipt(debtor,internal_exam_fee,r_no, r_date, s_name, s_ic, pay_mtd, tuition_fee, ptpk, r_status, createdate, createby, hostel_fee, receipt_type)VALUES('".$debtor."', '".$internal."', '".$new_no."', '".$_POST['date']."', '".$_POST['name']."', '".$_POST['ic']."', '".$pay_mtd."', '".$tuition."', '".$loan."', 'ACTIVE', '".DATE_TODAY."', '".$_SESSION['id']."', '".$hostel."', '2')";
