...
if(isset($_POST['submit']) && $_POST['submit'] == 'save'){
	...
	if(isset($error_ext)){
		...
		if(isset($_POST['hostel'])){
			...
			,c_postcode,c_state,chinese_name,h_contact,hp_contact,guardian,school,birthday,age,gender,m_status,religion
			,s_desc,s_status,tuition_fee,p_method,cost_per_month,p_month,date_join,course,photo".$a_hostel.")VALUES('".mysqli_real_escape_string($conn,$_POST['email'])."'
			...
			,'".mysqli_real_escape_string($conn,$_POST['school'])."','".$_POST['birthday']."'
			...
			,'".$_POST['join_date']."','".$_POST['course']."','".$file."'".$b_hostel.")";
...
if(isset($_GET['action']) && $_GET['action'] == 'edit'){
	...
	if(isset($error_ext)){
		...
		if(isset($_POST['hostel'])){
			...
			,date_join='".$_POST['join_date']."',course='".$_POST['course']."'".$new_file.$hostel." WHERE id = '".$_GET['id']."'";
			if($result = mysqli_query($conn, $qry)){
				echo "<script>
