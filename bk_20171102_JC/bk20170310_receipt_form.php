...
$chk_qry = "SELECT c_desc FROM cart";
           ...
           <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="desc" value="" <?=$require?>>
                ...
                <div class="form-group">
                    <label>Amount</label>
                    <input type="text" class="form-control" name="amount" value="" <?=$require?>>
                </div>
           ...
           <div class="col-md-12">
            <div class="form-group">
                ...
                <div id="basic-example">
                    <input id="my-input1" class="form-control typeahead" name="name" type="text" value="" style="width:523px;" onfocusout="showHint(this.value);" required>
                </div>
            </div>
                <div id="txtHint"></div>
            </div>
