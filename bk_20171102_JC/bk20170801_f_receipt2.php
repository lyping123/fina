...
if(isset($_POST['submit']) && $_POST['submit'] == 'edit'){
	...
	$qry_save = "UPDATE f_receipt SET debtor_ptpk='".$debtor_ptpk."', debtor='".$debtor."', internal_exam_fee='".$internal."', s_name='".mysqli_real_escape_string($conn,$_POST['name'])."', s_ic='".$_POST['ic']."', pay_mtd='".$pay_mtd."', tuition_fee='".$tuition."', ptpk='".$loan."', hostel_fee='".$hostel."'".$date." WHERE id = '".$_GET['id']."' ";
