...
<?php 
	...
	$qry_rcp = "SELECT * FROM receipt WHERE r_status = 'ACTIVE'".$s_name." ORDER BY id DESC";
        ...
        <div class="row">
            <div class="col-md-12">	
                <div class="form-group">
                    <form action="receipt_list.php" method="get">
                        <div class="row">
                            <div class="col-lg-3">
                                <label>Search Student</label>
                                <div id="basic-example">
                                    <input id="my-input1" class="form-control typeahead" name="name" type="text" value="" style="width:262.5px;" onfocusout="showHint(this.value);" required>
                                </div>
                            </div>
                        </div>
                        <br />
            ...
            <table id="mytable" class="table table-bordred table-striped" style="width:100%">
				...
				?>
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li><a href="receipt_edit.php?&id=<?=$row_rcp['id']?>">Edit</a></li>
