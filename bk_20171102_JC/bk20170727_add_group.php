...
if(isset($_POST['submit']) && $_POST['submit'] == 'save'){
	...
	$qry = "INSERT INTO student_group(c_id,g_name,g_status,g_level)VALUES('".mysqli_real_escape_string($conn,$_POST['course'])."','".mysqli_real_escape_string($conn,$_POST['gname'])."','ACTIVE','".mysqli_real_escape_string($conn,$_POST['level'])."')";
