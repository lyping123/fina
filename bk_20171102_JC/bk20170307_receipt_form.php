...
<div class="panel panel-info">
    ...
    <div class="panel-body">  
            <div class="col-md-12">
                <div class="form-group">
					<input type="checkbox" id="internal" name="internal" value="internal" onclick="validate4()"> Internal Exam Fee
                </div>
            </div>
    </div>  
</div>
<div class="panel panel-info">
    ...
    <div class="panel-body">  
            <div class="col-md-12">
                <div class="form-group">
					<input type="checkbox" id="hostel" name="hostel" value="hostel" onclick="validate3()"> Deduct From Hostel Fee
                </div>
            </div>
    </div>  
</div>
