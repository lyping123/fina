    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="student_list.php">Synergy College</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="new_student.php">Student Form</a>
                    </li>
                    <!--<li>
                        <a href="#">Attendance</a>
                    </li>-->
                    ...
                    <li class="dropdown">
                        <a href="#">Fast Receipt<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                ...
                <? if(isset($_SESSION['level']) && $_SESSION['level'] == 'admin' || $_SESSION['level'] == 'superadmin' || $_SESSION['dp'] == 'Department Head'){ ?>
                    <li class="dropdown">
