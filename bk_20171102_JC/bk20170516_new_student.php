...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <div class="col-md-5">
            ...
            <input type="text" class="form-control" name="r_address" value="" required>
            </div>
            <div class="form-group">
            <label>Residential Postcode</label>
            <input type="text" class="form-control" name="r_postcode" value="" required>
            </div>
            <div class="form-group">
            ...
            <input type="text" class="form-control" name="c_address" value="" required>
            </div>
            <div class="form-group">
            <label>Correspondence Postcode</label>
            <input type="text" class="form-control" name="c_postcode" value="" required>
            </div>
            <div class="form-group">
            ...
            <input type="text" class="form-control" name="i_fee" value="" required>
            </div>
            <div class="form-group">
            <label>Tuition Fee</label>
            <input type="text" class="form-control" name="fee" value="" required>
            </div>
            <div class="form-group">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                <label>Month</label>
                <input type="text" class="form-control" name="month" value="" required>
                </div>
            </div>
            <div class="panel panel-info">
                <header class="panel-heading">
        ...
        <div class="col-md-5">
          ...
          <div class="col-md-12" style="padding-left:0px;">
           <div class="col-md-8" style="padding-left:0px; height:30px;">
            ...
            <input class="form-control" size="16" type="text" value="" required="required">
          ...
          <div class="col-md-12" style="padding-left:0px;">
           ...
           <div class="col-md-3 col-md-offset-1" >
            ...
            <input type="text" class="form-control" name="s_id" value="" required>
            </div>
            <div class="form-group">
            <label>Contact(Home)</label>
            <input type="text" class="form-control" name="h_contact" value="" required>
            </div>
            <div class="form-group">
            <label>Contact(H/P)</label>
            <input type="text" class="form-control" name="hp_contact" value="" required>
            </div>
            <div class="form-group">
            <label>Guardian</label>
            <input type="text" class="form-control" name="guardian" value="" required>
            </div>
            <div class="form-group">
            <label>School</label>
