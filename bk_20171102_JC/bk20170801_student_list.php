...
$qry = "SELECT * FROM student WHERE s_status = 'ACTIVE'".$s_name." ORDER BY id DESC";
            ...
            <td><button class="btn btn-default btn-xs"><span class="glyphicon glyphicon-eye-open"></span></button></td>
              ...
              <td><div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    <li class="divider"></li>
                    <li><a href="internal_exam_fee_list.php?id=<?=$row['id']?>&name=<?=$row['s_name']?>&ic=<?=$row['ic']?>">Internal Exam Fees</a></li>
