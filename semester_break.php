...
}elseif(isset($_GET['action']) && $_GET['action'] == 'msg_success_up'){
	$system_msg .= systemMsg('alert-success','Success!','Successfully upload semester file in Group.');	
}elseif(isset($_GET['action']) && $_GET['action'] == 'msg_fail_up'){
	$system_msg .= systemMsg('alert-danger','Fail!','Fail to Upload.');
}
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Semester Break
                ...
                <!--<div class="table-responsive">-->
                    ...
                    <table id="example1" class="table table-bordred table-striped" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <td><?php if($row['end_date'] < DATE_TODAY1){ echo 'Expired';}else{ echo 'Active ';}?></td>
