...
$qry = "SELECT * FROM f_cn WHERE cn_status = 'ACTIVE' AND id = '".$_GET['id']."'";
...
$new_no = $no + $c_row;
?>
<form class="form-horizontal" method="post" action="f_cn_detail1.php?id=<?=$row['id']?>" enctype="multipart/form-data"> 
		<div class="row">
            <div class="col-lg-12">
    ...
    <div class="panel-body">
           <div class="col-md-12">
            ...
            <div class="col-lg-7">
                ...
                <!--<div class="form-group">
					<a class="btn btn-danger pull-right" href="f_cn.php?action=clear" onclick="return confirm('Confirm to clear all record?')"> Clear All </a><br />
                </div>-->
<style>
#table.table, th, td {
...
  </tr>
<?php 
$qry_cart = "SELECT * FROM f_cn_detail WHERE cn_id = '".$_GET['id']."'";
$result_cart = mysqli_query($conn, $qry_cart);
while($row_cart = mysqli_fetch_array($result_cart)){
?>
  <tr>
    <td><?=nl2br($row_cart['cn_desc'])?></td>
    <td><?=$row_cart['cn_amount']?></td>
    <td><a class="btn btn-danger" href="f_cn_detail1.php?action=delete&id=<?=$row_cart['id']?>&r_id=<?=$row_cart['cn_id']?>" onclick="return confirm('Confirm to Delete this Record?')"> Delete </a></td>
  </tr>
<?php }?>
</table>
</div>
...
<form class="form-horizontal" method="post" action="f_cn1.php?action=edit&id=<?=$_GET['id']?>" enctype="multipart/form-data"> 
        <div class="row">
            <div class="col-lg-6">
<div class="panel panel-info">
    <header class="panel-heading">
    ...
    <div class="panel-body">
           <div class="col-md-12">
            ...
            <div class="form-group">
                <label>Orginal Bill No</label>
                <input type="text" class="form-control" name="org_bill_no" value="<?=$row['org_bill_no']?>">
            </div>
            </div>
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input class="form-control" size="16" type="text" value="<?=$row['cn_date']?>">
