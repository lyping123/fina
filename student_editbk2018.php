...
$qry = "SELECT *,s.id as newid FROM student as s left join login as l on l.id=s.p_id WHERE s.id = '".$_GET['id']."'";
...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <form class="form-horizontal" method="post" action="add_student.php?action=edit&id=<?=$row['newid']?>" enctype="multipart/form-data">    
        <div class="col-md-5">
...
<script>
    $(document).on("change","#jan",function(){
    var a=$("#jan").val();
    var b=new Date();
    var c=b.getMonth();
    var month=c+1;
