    ...
    <br />
        ...
        <td colspan="1" valign="bottom" width="30%" align="right">
            <div style="<!--direction:rtl-->;text-align: left;margin-left: 100px;">
                ...
                <div><strong>No</strong>: <?=$row['cn_no']?><br /></div>
                <div><strong>Date</strong>: <?=date_format(new DateTime($row['cn_date']),'d-m-Y')?></div>
                <div><strong>Org. Bill No</strong>: <?=$row['org_bill_no']?></div>
            </div>
        </td>
    </tr>
  </table>
