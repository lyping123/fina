        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav">
					...
					<li><a href="bill_history.php">My Account</a></li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="internship_form.php">Internship Agreement</a></li>
                            <li><a href="handbook.php">Student Handbook</a></li>
                            <?php 
                            $qry="select * from student where id='".$_SESSION["id"]."' AND h_status='YES'";
                            $sttr=mysqli_query($conn,$qry);
                            $num=mysqli_num_rows($sttr);                    
                            
                            if($num>0){ ?>
                            <li><a href="agreement.php">Hostel Rules</a></li>
                            <?php }?>
                            <li><a href="syllabus.php">Syllabus</a></li>
                            <li><a href="trainingpathway.php">Tranning Pathway</a></li>
                            <li><a href="upload_offerletter.php">Offer Letter</a></li>
                        </ul>
                    </li>
