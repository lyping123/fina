...
$new_no = $no + $c_row;
?>
<form class="form-horizontal" method="post" action="f_rp_detail.php?id=<?=$row['id']?>" enctype="multipart/form-data"> 
		<div class="row">
            <div class="col-lg-12">
...
?>
  <tr>
    ...
    <td><a class="btn btn-danger" href="f_rp_detail.php?action=delete&id=<?=$row_cart['id']?>&r_id=<?=$row_cart['r_id']?>" onclick="return confirm('Confirm to Delete this Record?')"> Delete </a></td>
  </tr>
<?php }?>
</table>
</div>
